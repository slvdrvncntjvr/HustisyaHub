    ...
    <div className="min-h-[calc(100vh-4rem)] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4" data-testid="text-learn-title">Legal Knowledge Base</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Empower yourself with legal templates and guides to protect your digital rights.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-100 dark:border-blue-900">
            <CardHeader>
              ...
              <CardTitle>Digital Rights</CardTitle>
              <CardDescription>
                Fundamental rights for every digital citizen
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-muted-foreground">
                ...
                <li>Right to credit for personal works</li>
                <li>Right to digital access</li>
                <li>Right to our identity</li>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 border-purple-100 dark:border-purple-900">
            <CardHeader>
              ...
              <CardTitle>Digital Responsibilities</CardTitle>
              <CardDescription>
                Duties to ensure a safe digital environment
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-muted-foreground">
                <li>Responsibility to report bullying, harassing, sexting, or identity theft</li>
                <li>Responsibility to cite works used for resources and researching</li>
                <li>Responsibility to download music, videos, and other materials legally</li>
                <li>Responsibility to model and teach students expectations of technology use</li>
                <li>Responsibility to keep data/information safe from hackers</li>
                <li>Responsibility not to falsify your identity in any way</li>
                <li>Responsibility to comply with legislation, regulations, code of conduct and best practices</li>
              </ul>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center mb-12 text-sm text-muted-foreground">
          <p>Source: <a href="https://ijarcce.com/wp-content/uploads/2020/02/IJARCCE.2020.9204.pdf" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">International Journal of Advanced Research in Computer and Communication Engineering (IJARCCE)</a></p>
        </div>
